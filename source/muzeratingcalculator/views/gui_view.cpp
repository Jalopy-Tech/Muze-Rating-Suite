...
{
     calculatorDialog.muzeRatingLabelValue->setText(QString::number(rating,'f',1));
}

void GuiView::setMuzeRating()
{
     calculatorDialog.muzeRatingLabelValue->setText("");
}

void GuiView::setStarsPerRatedTrack(float starsPerRatedTrack)
{
     calculatorDialog.starsPerRatedTrackLabelValue->setText(QString::number(starsPerRatedTrack,'f',1));

}

void GuiView::setStarsPerRatedTrack()
{
     calculatorDialog.starsPerRatedTrackLabelValue->setText("");
